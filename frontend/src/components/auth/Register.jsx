    ...
    <div className='Register'>
      ...
      <div
        className={`icon d-flex w-100 ${
          onAdditional ? 'justify-content-between' : 'justify-content-end'
        }`}
      >
        <i
        ...
        <i
          onClick={() => {
            document.querySelector('.Register').classList.add('leave');
      ...
      <form className='Register-form mt-5'>
        ...
        {onAdditional ? (
          ...
          <button type='button' onClick={next} className='mt-5 btn btn-block'>
            Next
          </button>
        )}
      </form>
