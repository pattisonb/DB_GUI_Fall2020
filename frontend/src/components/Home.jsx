      ...
      <div className="container-fluid master-container">
        ...
        <nav className="side-nav-bar-container jumbotron">
          ...
          <div className="location-menu-box form-group">
            ...
            <select name="location-menu" id="location-menu" className="form-control">
          ...
          <div class="condition-radio-box form-check form-check-inline">
            <input class="form-check-input" type="radio" name="condition-radio-options" id="radio-btn-new" value="" />
            <label class="form-check-label" for="radio-btn-new">New</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="condition-radio-options" id="radio-btn-used" value="" />
            <label class="form-check-label" for="radio-btn-used">Used</label>
          </div>

          <div class="price-range-input-box">
            <input type="text" class="price-range-input-min form-control form-control-sm" placeholder="$ Min" />
            <input type="text" class="price-range-input-max form-control form-control-sm" placeholder="$ Max" />
            <button type="button" className="btn btn-secondary btn-sm">Go</button>
          </div>

          <div className="logout-btn-box">
            <button type="button" className="btn btn-light logout-btn">Log out</button>
          </div>
        </nav>

        <div className="search-bar-container">
          <div className="input-group">
            <input type="text" className="search-bar-input form-control" placeholder="Enter an item or a seller to search for..." />
        ...
        <div className="container-fluid products-container mt-4">
          {
            this.state.products.map((product, idx) =>
              <div key={idx} className="product-box">
                <img src={iPhone12Img} alt="iPhone12-img" width="100px" height="100px" />
                <div>
                  <Link to='/products/5' className="product-name"><p>iPhone12 Pro,<br />256GB</p></Link>
                  <div className="product-price">$999</div>
                  <br></br>
                  <p>By <a href="#">Seller</a></p>
                </div>
              </div>
            )
          }
