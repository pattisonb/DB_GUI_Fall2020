...
export class CurrentItems extends React.Component {
    ...
    handleEdit(itemId) {
        ...
        this.productsRepository.getProduct(itemId) 
    ...
    deleteItem(confirmed) {
        if (confirmed && this.state.deletingItemId) {
            ...
            this.productsRepository.getListings(this.props.id)
                    ...
                    {this.loading ? (
                        ...
                        <>
                            <div className='d-flex my-5'>
                                {this.state.userId == parseInt(window.localStorage.getItem('id')) &&
                                    <Link
                            ...
                            <ul className='list-group'>
                                {this.state.updateItemId
                                    ? this.state.items
                                        .filter(
                                            item => item.ItemID === this.state.updateItemId
                                        )
                                        .map(item => (
                                            <form
                                            ...
                                            >
                                                <div className='d-flex flex-column col-5 p-0'>
                                                    ...
                                                    <img
                                                        ...
                                                        src={this.state.updateItemImage}
                                                        alt={this.state.updateItemName}
                                                    />
                                                    <h6 className='mt-4'>
                                                        New Image Url:
                                                    </h6>
                                                    <input
                                                        onChange={e =>
                                                            this.setState({updateItemImage: e.target.value})
                                                        }
                                                        type='text'
                                                        value={this.state.updateItemImage}
                                                    />
                                                </div>
                                                <div className='col-7'>
                                                    $
                                                    <input
                                                        ...
                                                        onChange={e =>
                                                            this.setState({updateItemPrice: e.target.value})
                                                        }
                                                        className='Edit-Price bg-primary rounded text-center'
                                                    />
                                                    <select
                                                        value={this.state.updateCondition}
                                                        onChange={e =>
                                                            this.setState({updateCondition: e.target.value})
                                                        }
                                                        name='condition'
                                                        id='condition'
                                                    >
                                                    ...
                                                    <textarea
                                                        value={this.state.updateItemDetails}
                                                        onChange={e =>
                                                            this.setState({updateItemDetails: e.target.value})
                                                        }
