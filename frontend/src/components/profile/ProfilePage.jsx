            ...
            <div className='ProfilePage p-5'>
                ...
                <div className="mx-auto">
                    <ul className="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" id="favoriteItems-tab" data-toggle="tab" href="#favoriteItems" role="tab" aria-controls="favoriteItems" aria-selected="false"><h4 id="text">Favorites({this.state.favoriteItems.length})</h4></a>
                        </li>
                        }
                    </ul>
                    <div className="tab-content profile-tab">
                        <div className="tab-pane fade show active pt-5" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                        ...
                        <div className="tab-pane fade pt-5" id="favoriteItems" role="tabpanel" aria-labelledby="favoriteItems-tab">
